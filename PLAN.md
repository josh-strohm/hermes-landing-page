...
Create a conversion-focused landing page that turns small business owners into clients for a **done-for-you Hermes Agent deployment**. This covers more than installation: the full infrastructure, integrations, and business-specific configuration required for the agent to do **real, recurring work** (not a chatbot demo that sits unused after week one).
...
> **Strohm Partners sets up Hermes Agent, a self-hosted AI employee that remembers your business, runs on a schedule, and works from the apps you already use. You never have to touch servers, API keys, or YAML files.**
...
**Get a working AI agent that knows your business, runs 24/7 on dedicated infrastructure, and handles real tasks. It is installed, configured, and maintained for you.**
...
### Hero subheadline
*Strohm Partners deploys [Hermes Agent](https://hermes-agent.nousresearch.com) on secure cloud infrastructure, connects it to the tools you already use, and configures real recurring tasks, including lead follow-up, inbox summaries, appointment prep, and more. You get results without touching a terminal.*
...
- Warm gold accent (`#C6AC8F` / `#EAE0D5`) on active elements, nodding to Hermes WebUI "Sienna" / default gold palette without copying their UI wholesale
...
**Intro:** Frame the deliverable as three layers: **Infrastructure**, **Configuration**, and **Workflows**.

**Three pillar cards (icon + title + bullet list):**

#### Pillar A: Infrastructure (the part you never want to think about)
- Managed VPS or cloud host (e.g. Hostinger or Hetzner, sized for the business)
...
- Messaging surface: SMS, email, Telegram, or Slack, based on the owner's preference
...
**Optional:** Link to existing Strohm Partners website client work (JT3 Hauling, Mrs. Redbottom's, Central PA Auto Glass) as proof of local business fluency. Add a separate subsection: *"We already build AI-powered systems for local businesses."*
...
2. **What is Hermes Agent, and is it like ChatGPT?**
...
3. **How much do AI model API costs run?**  
   Typically $30–$120/month for a small business with daily briefings and moderate email drafting; it depends on volume. We configure spend caps and show you a monthly usage summary.
...
7. **What if I already pay for ChatGPT Team?**  
   Keep it for ad-hoc brainstorming if you like. Hermes handles *operational* work: scheduled, connected, and remembered. They complement each other.
...
- **Yes:** Server/cloud, calendar, inbox, clock, checklist, phone-message, shield. These are operational metaphors.
...
If real photos are added later: owner at job site, office manager at desk, or phone notification close-up, all in warm natural light, not staged headset support reps.
...
- **Local business fluency.** Use examples from trades, cleaning, auto, and wellness, mirroring Strohm Partners' existing client verticals.
...
- No external font blocking. Use a system font stack or self-host an Inter subset.
...
**Bundle idea (future):** "Growth Stack", which combines the website and Hermes Growth tier at a 10% discount.
